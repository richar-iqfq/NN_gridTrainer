...
class DatasetBuilder():
    def __init__(self) -> None:
        '''
        Class for Building datasets classes
        '''
    ...
    def create_datasets(self) -> tuple:
        ...
        '''
        x_train, x_val, x_test, y_train, y_val, y_test = self.processer.Retrieve_Splitted()
        ...
        return Mol_TrainDataset(), Mol_ValDataset(), Mol_TestDataset()